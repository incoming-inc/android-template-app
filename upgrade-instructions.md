...
Set the Push Video SDK version to 1.6.12 in the dependencies section of `build.gradle`. e.g.
...
Set the Push Video SDK version to 1.6.12 in the dependencies section of `pom.xml`. e.g.

    <properties>
        <pvn.version>1.56.12</pvn.version>
        <android.support.version>22.2.1</android.support.version>
        <play-services.version>7.5.0</play-services.version>
    </properties>
